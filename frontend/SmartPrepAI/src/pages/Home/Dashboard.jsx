...
import { CARD_BG } from "../../utilis/data";
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto pt-4 pb-4">
          ...
          {sessions?.length > 0 ? (
            sessions.map((data, index) => (
              <SummaryCard
                ...
                onDelete={() => setOpenDeletedAlert({ open: true, data })}
              />
            ))
          ) : (
        ...
        <button
          className="h-12 md:h-12 flex items-center justify-center gap-3 bg-gradient-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:text-white transition-colors cursor-pointer hover:shadow-2xl hover:shadow-orange-300 fixed bottom-10 md:bottom-20 right-10 md:right-10"
