    ...
    return (
        <>
            <div className=' w-full min-h-full bg-[#FFFCEF] '>
                ...
                <div className="container mx-auto px-4 pt-4 pb-[200px] relative z-10">
                    <header className='flex justify-between items-center mb-16 '>
                        ...
                        <button className='bg-linear-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer ' onClick={() => setOpenAuthModal(true)}>Login/Signup</button>
                    )}
                    </header>
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        ...
                        <div className="w-full md:w-1/2">
                            <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-6 '>
                                Get role-specific question, expand answer when you need them, dive deeper into concepts, and organize everything your way.
